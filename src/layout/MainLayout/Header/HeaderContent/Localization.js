...
const Localization = () => {
  ...
  return (
    <Box sx={{ flexShrink: 0, ml: 0.75 }}>
      ...
      >
        <i className='icon-multilingual ottr-icon' style={{fontSize: "22px", marginTop: '5px', color: "#262626"}}></i>
      </IconButton>
      <Popper
            ...
            <Paper sx={{ boxShadow: theme.customShadows.z1 }}>
              <ClickAwayListener onClickAway={handleClose}>
                ...
                >
                  ...
                  <ListItemButton selected={i18n === 'mr'} onClick={() => handleListItemClick('mr')}>
                    <ListItemText
                      primary={
                        <Grid container>
