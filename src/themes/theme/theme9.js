...
const Theme9 = (colors, mode) => {
  ...
  // let primaryColors = ['#feeaee', '#fdd5dd', '#fcacbb', '#fa829a', '#f95978', '#f72f56', '#c62645', '#941c34', '#631322', '#190509'];
  let primaryColors = ['#d9dae4', '#ecedf1', '#b3b6c8', '#8c91ad', '#797f9f', '#404876', '#333a5e', '#262b47', '#1a1d2f', '#06070c'];
